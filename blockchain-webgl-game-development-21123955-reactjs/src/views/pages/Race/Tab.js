...
export default function Race() {
  ...
  return (
    <Box className={classes.mainbox}>
      <Box pt={4} pb={3} className={`${classes.mainboxtext} subtext`}>
        {value === 0 && <Typography variant="h3">Racing Events</Typography>}
        {value === 1 && <Typography variant="h3">Upcoming Races</Typography>}
        {value === 2 && <Typography variant="h3">Racing Result</Typography>}
        {value === 3 && <Typography variant="h3">Leaderboard</Typography>}
      </Box>
        ...
        <Box>
            ...
            <Container>
              <Box className={classes.tabBox}>
                <Box className={classes.TabButtonsBox}>
                  ...
                  <Button
                    className={tabview === "RacingResults" ? "active" : " "}
                    onClick={() => setTabView("RacingResults")}
                  >
                    Results
                  </Button>
                  <Button
          ...
          <Container>
            ...
            <Box className={classes.tabBoxbg}>
              ...
              {tabview === "RacingResults" ? <RacingResults /> : ""}
