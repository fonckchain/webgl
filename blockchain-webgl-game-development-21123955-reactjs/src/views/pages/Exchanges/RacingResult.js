      ...
      <Box>
        ...
        <TableContainer component={Paper}>
          <Table aria-label="collapsible table">
            <TableHead className={classes.tableHead}>
              <TableRow>
                <TableCell align="center">Race Track</TableCell>
                <TableCell align="center" style={{ paddingLeft: "63px" }}>
                  Class
                </TableCell>
                <TableCell align="center" style={{ paddingLeft: "38px" }}>
                  Distance
                </TableCell>
                <TableCell align="center" style={{ paddingLeft: "38px" }}>
                  Entry Fee
        ...
        <Accordion defaultExpanded={true}>
          <AccordionSummary
            ...
            id="panel1a-header"
            style={{ background: "#110720", minHeight: "0px" }}
          ></AccordionSummary>
          <TableContainer component={Paper}>
            <Table aria-label="collapsible table">
              <TableHead
              ...
              >
                <TableRow>
                  <TableCell align="center" minWidth="200px">
                    Race #453
                  </TableCell>
                  <TableCell align="center" minWidth="200px">
                    Z Class
          ...
          <TableContainer component={Paper}>
            <Box style={{ padding: "10px", backgroundColor: "#110720" }}>
              <Table aria-label="collapsible table">
                <TableHead className={classes.tableHead}>
